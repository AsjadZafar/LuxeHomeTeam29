...
<html lang="en">
  ...
  <meta name="description"
    content="Get in touch with LuxeHome – the premier destination for smart home technology and automation. Our experts are ready to assist with all your smart living inquiries." />
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <a href="contact.php" class="nav-link">Contact</a>
        ...
        <div class="flex items-center space-x-4">
          <button class="action-btn hover:text-emerald-600"><i class="fas fa-search"></i></button>
          <button class="action-btn relative hover:text-emerald-600">
            <i class="fas fa-shopping-cart"></i>
            <span
              class="cart-badge absolute -top-2 -right-2 bg-emerald-600 text-white text-xs px-1.5 rounded-full">3</span>
          </button>
          <button class="action-btn hover:text-emerald-600"><i class="fas fa-user"></i></button>
        </div>
      </div>
    </div>
  </header>
...
<hr class="my-6 border-gray-300">
  ...
  <div class="text-center">
    ...
    <p class="mt-3 font-semibold" style="color: black;">
      Asjad
    </p>
  </div>
