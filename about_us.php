...
<body class="bg-gray-50">
  ...
  <!-- main content area; hides horizontal overflow to prevent layout break and keep the page clean -->
    ...
    <!-- About Us Hero Section -->
      ...
      <!-- Relative positioning, dark blue background, white text for contrast, overflow hidden to prevent child elements from overflowing, top and bottom padding responsive for different screen sizes -->

      <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center">
        <!--Centered container with max width, padding, and flexible layout for mobile and desktop -->

        <!-- Left Side -->
        <div class="relative md:w-1/2 space-y-6 z-10 pb-20 sm:pb-24 md:pb-0">
          <!-- half width on desktop, vertical spacing between items, layered above background, responsive bottom padding -->
          ...
          <div class="inline-flex items-center gap-2
                  ...
                  rounded-full
                  font-semibold
                  shadow-lg">  <!-- rounded badge with icon and text, green colors, small padding, shadow, and blur effect, items aligned in a row -->
        ...
        <!-- Right Side -->
        <div class="relative md:w-1/2 flex items-center justify-center overflow-visible pr-8 sm:pr-12 md:pr-0">
          <!-- right side of container, half width on desktop, centers content, allows overflow, responsive right padding -->
          <div class="hidden md:block absolute 
                  ...
                  <!-- ellipse background, hidden on small screens, absolute positioned, vertically centered, hides overflow, stacked behind other content, smooth transition -->
            ...
            <img src="images/herosection/livingroom.jpg" alt="Luxury smart home interior"
              ...
              <!-- image fills its container fully, keeps aspect ratio, covers entire area without stretching using object-cover -->
          </div>
        </div>
