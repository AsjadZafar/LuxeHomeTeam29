...
CREATE TABLE `addresses` (
  ...
  `address_line1` varchar(100) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `address_line2` varchar(100) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
